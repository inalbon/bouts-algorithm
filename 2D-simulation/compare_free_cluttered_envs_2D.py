...
plt.title('Error of mean concentration for different environments')
plt.xlabel('Environment')
plt.ylabel('Localization error [m]')
plt.xticks([1, 2], ['free', 'cluttered'])
#plt.ylim(0, error_max+0.1*error_max)
plt.savefig('boxplot_mean.eps')

plt.figure()
plt.boxplot(total_error_bouts)
plt.title('Error of bouts algorithm for for different environments')
plt.xlabel('Environment')
plt.ylabel('Localization error [m]')
plt.xticks([1, 2], ['free', 'cluttered'])
# plt.ylim(0, error_max+0.1*error_max)
